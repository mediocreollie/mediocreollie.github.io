...
test('reference use requires a real garment measurement',()=>{assert.equal(G.hasMeasurements({category:'Top',measurements:{chest:null}}),false);assert.equal(G.hasMeasurements({category:'Top',measurements:{chest:102}}),true);assert.equal(G.hasMeasurements({category:'Trousers',measurements:{sleeve:80}}),false);assert.equal(G.hasMeasurements({category:'Trousers',measurements:{inseam:80}}),true)});
