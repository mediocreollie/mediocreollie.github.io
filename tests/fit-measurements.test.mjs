...
test('UI submit saves a versioned snapshot without a score and preserves legacy records',async()=>{
 ...
 const context={FitMeasurements:F,document:{getElementById:get},val:id=>get(id).value,current:()=>profile,structuredClone,crypto:{randomUUID:()=> 'new-id'},esc:s=>String(s),save:()=>saves++,renderHistory(){},toast(){}};
